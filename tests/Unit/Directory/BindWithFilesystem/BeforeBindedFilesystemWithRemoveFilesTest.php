...
class BeforeBindedFilesystemWithRemoveFilesTest extends FileSystemCase
{
    private $outPath;

    public function setUp(): void
    {
        $this->createDirectory($this->outPath = $this->getRuntimePath() . '/BeforeBindedFilesystemWithRemoveFilesTest');
    }
