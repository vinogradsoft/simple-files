...
class BeforeBindedFilesystemWithRemoveFilesAndSetLocalNameTest extends FileSystemCase
{
    ...
    public function testBindWithFilesystem()
    {
        ...
        self::assertFileDoesNotExist($outPath . '/renamedChild/file1.txt');
        self::assertFileDoesNotExist($outPath . '/renamedChild/root/file7.txt');
        self::assertFileDoesNotExist($outPath . '/renamedChild/root/child1/file6.txt');
        self::assertFileDoesNotExist($outPath . '/renamedChild/root/child1/child2/file5.txt');
        self::assertFileDoesNotExist($outPath . '/renamedChild/root/child1/child2/child3/file4.txt');
        self::assertFileDoesNotExist($outPath . '/renamedChild/root/child1/child2/child3/child4/file3.txt');
        self::assertFileDoesNotExist($outPath . '/renamedChild/root/child1/child2/child3/child4/child5/file2.txt');
