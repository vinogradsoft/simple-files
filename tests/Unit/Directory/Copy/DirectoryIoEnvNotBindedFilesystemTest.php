...
class DirectoryIoEnvNotBindedFilesystemTest extends IoEnvCase
{
    protected $outDirectoryName = 'DirectoryCopyNotBindedFilesystemTest';
    ...
    public function testCopy()
    {
        ...
        self::assertDirectoryExists($outPath . '/copy3/childL/root/child1/child2/child3/child4/child5');
        self::assertFileExists($outPath . '/copy3/childL/file1.txt');
        self::assertFileExists($outPath . '/copy3/childL/root/file7.txt');
        self::assertFileExists($outPath . '/copy3/childL/root/child1/file6.txt');
        self::assertFileExists($outPath . '/copy3/childL/root/child1/child2/file5.txt');
        self::assertFileExists($outPath . '/copy3/childL/root/child1/child2/child3/file4.txt');
        self::assertFileExists($outPath . '/copy3/childL/root/child1/child2/child3/child4/file3.txt');
        self::assertFileExists($outPath . '/copy3/childL/root/child1/child2/child3/child4/child5/file2.txt');
    }
