...
class DirectoryMoveBindedFilesystemTest extends IoEnvCase
{
    protected $outDirectoryName = 'DirectoryMoveBindedFilesystemTest';
    ...
    public function testMove()
    {
        ...
        self::assertDirectoryExists($outPath . '/move/childL/root/child1/child2/child3');
        self::assertDirectoryExists($outPath . '/move/childL/root/child4/child5');
        self::assertFileExists($outPath . '/move/childL/file1.txt');
        self::assertFileExists($outPath . '/move/childL/root/file7.txt');
        self::assertFileExists($outPath . '/move/childL/root/child1/file6.txt');
        self::assertFileExists($outPath . '/move/childL/root/child1/child2/file5.txt');
        self::assertFileExists($outPath . '/move/childL/root/child1/child2/child3/file4.txt');
        self::assertFileExists($outPath . '/move/childL/root/child4/file3.txt');
        self::assertFileExists($outPath . '/move/childL/root/child4/child5/file2.txt');

        self::assertEquals($outPath . '/move/childL/file1.txt', $file1->getPath()->getSource());
        self::assertEquals($outPath . '/move/childL/root/file7.txt', $file7->getPath()->getSource());
        self::assertEquals($outPath . '/move/childL/root/child1/file6.txt', $file6->getPath()->getSource());
        self::assertEquals($outPath . '/move/childL/root/child1/child2/file5.txt', $file5->getPath()->getSource());
        self::assertEquals($outPath . '/move/childL/root/child1/child2/child3/file4.txt', $file4->getPath()->getSource());
        self::assertEquals($outPath . '/move/childL/root/child4/file3.txt', $file3->getPath()->getSource());
        self::assertEquals($outPath . '/move/childL/root/child4/child5/file2.txt', $file2->getPath()->getSource());

        self::assertEquals($outPath . '/move/childL', $childL->getPath()->getSource());
        self::assertEquals($outPath . '/move/childL/root', $root->getPath()->getSource());
        self::assertEquals($outPath . '/move/childL/root/child1', $child1->getPath()->getSource());
        self::assertEquals($outPath . '/move/childL/root/child1/child2', $child2->getPath()->getSource());
        self::assertEquals($outPath . '/move/childL/root/child1/child2/child3', $child3->getPath()->getSource());
        self::assertEquals($outPath . '/move/childL/root/child4', $child4->getPath()->getSource());
        self::assertEquals($outPath . '/move/childL/root/child4/child5', $child5->getPath()->getSource());
        ...
        self::assertDirectoryNotExists($child5Path);

        self::assertFileNotExists($file1Path);
        self::assertFileNotExists($file7Path);
        self::assertFileNotExists($file6Path);
        self::assertFileNotExists($file5Path);
        self::assertFileNotExists($file4Path);
        self::assertFileNotExists($file3Path);
        self::assertFileNotExists($file2Path);
    }
