...
class DirectoryAdditionalAssertNotBindedFilesystemWithSetLocalNameTest extends AdditionalAssertCase
{
    protected $outDirectoryName = 'DirectoryAdditionalAssertNotBindedFilesystemWithSetLocalNameTest';
