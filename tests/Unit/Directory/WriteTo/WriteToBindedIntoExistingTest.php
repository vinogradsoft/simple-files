...
class WriteToBindedIntoExistingTest extends IoEnvCase
{
    protected $outDirectoryName = 'WriteToBindedTest';
    ...
    public function testWriteTo()
    {
        ...
        self::assertFileExists($file1PathControl = $outPath . '/childL/file1.txt');
        self::assertFileExists($file7PathControl = $outPath . '/childL/root/file7.txt');
        self::assertFileExists($file6PathControl = $outPath . '/childL/root/child1/file6.txt');
        self::assertFileExists($file5PathControl = $outPath . '/childL/root/child1/child2/file5.txt');
        self::assertFileExists($file4PathControl = $outPath . '/childL/root/child1/child2/child3/file4.txt');
        self::assertFileExists($file3PathControl = $outPath . '/childL/root/child1/child2/child3/child4/file3.txt');
        self::assertFileExists($file2PathControl = $outPath . '/childL/root/child1/child2/child3/child4/child5/file2.txt');
