...
class WriteToNotBindedIntoExistingTest extends IoEnvCase
{
    protected $outDirectoryName = 'WriteToNotBindedIntoExistingTest';
    ...
    public function testWriteTo()
    {
        ...
        self::assertFileExists($file1Path = $outPath . '/childL/file1.txt');
        self::assertFileExists($file7Path = $outPath . '/childL/root/file7.txt');
        self::assertFileExists($file6Path = $outPath . '/childL/root/child1/file6.txt');
        self::assertFileExists($file5Path = $outPath . '/childL/root/child1/child2/file5.txt');
        self::assertFileExists($file4Path = $outPath . '/childL/root/child1/child2/child3/file4.txt');
        self::assertFileExists($file3Path = $outPath . '/childL/root/child1/child2/child3/child4/file3.txt');
        self::assertFileExists($file2Path = $outPath . '/childL/root/child1/child2/child3/child4/child5/file2.txt');
